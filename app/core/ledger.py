...
# Cashier explicitly accepted trading on a market_closed rate (see app/core/gold_guard.py).
...
EVENT_PRODUCT_HARD_DELETED = "PRODUCT_HARD_DELETED"
EVENT_CATEGORY_HARD_DELETED = "CATEGORY_HARD_DELETED"
